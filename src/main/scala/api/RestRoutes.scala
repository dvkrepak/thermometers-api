...
trait RestRoutes extends ThermometerApi with ThermometerMarshaller {
  ...
  private val getThermometer: Route = pathPrefix("thermometer" / Segment) { _id =>
    get {
      ...
      pathEndOrSingleSlash {
        ...
        onComplete(futureResponse) {
          case Success(data) =>
            ...
            complete(StatusCodes.OK, resultJson.toString)
          case Failure(ex) =>
  ...
  val route: Route = getAllThermometers ~ postOneThermometer ~ editThermometer ~ getThermometer
}
